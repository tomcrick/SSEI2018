...
discussion; Section 5 concludes the paper with a summary of potential
extensions and applications of our work.
...
It is mportant to note that the size of connected components does not
...
components. Additionally, from Figure~\ref{fig:simplechainlengths}, it can be seen that simple
chains with the length 1 are the most common, and constitute about
47\% of chains. This is in alignment with the results of connected
component sizes presented earlier. Also, Table~\ref{tbl:delaystatscl}
presents summary statistics on chains of individual CS accounts.
