...
volume of activity on Twitter, the framework focuses on detecting possible 
...
As mentioned earlier, this graph is constructed to measure the indirect 
engagement amongst the CS accounts. This graph is constructed 
using the connected component that have more than one CS accounts in 
base graph (common components). Figure~\ref{fig:ccmethod} and Figrue~\ref{fig:coexistencegraph2} 
show example of three connected components and resulted coexistecne graph, 
respectively.
