...
root node, or it is directed to unavailable statuses. On the other hand, indegree of 
nodes can be 0 or more. Indegree in this graph indicate number of replies
directed to this status node. Hence, 0 indegree distinguishes leaf nodes.
Special case nodes are those with indegree and outdegree equal
